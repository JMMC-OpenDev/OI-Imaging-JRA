...
\begin{table}
\caption{Columns inserted in OI-FITS binary tables to store the values given by
the model.  \texttt{\textsl{NWAVE}} is the number of wavelengths. The \STRING{NS\_MODEL\_VIS2DATA} column was named \STRING{NS\_MODEL\_VIS2} in an early version of this document.
...
Label & Format & Description \\
\hline
\ROW{NS\_MODEL\_VIS2DATA}{Model of the squared visibility}
